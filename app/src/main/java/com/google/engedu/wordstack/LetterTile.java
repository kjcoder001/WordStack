...
public class LetterTile extends android.support.v7.widget.AppCompatTextView {
    ...
    /**
     * Changed the return type of moveToViewGroup from void to char.
     * @param targetView
     * @return letter , the character added to the view (either word1 or word2)
     */
    ...
    /**
     * My code below.
     * This method is used to initiate a drag event on a view . In this case its the LetterTile.
     * startDrag() accepts 4 parameters as shown.
     * The logic to check whether a tile is frozen or unfrozen is written in moveToViewGroup method.
     * @param motionEvent
     * @return boolean
     */
